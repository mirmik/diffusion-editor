...
сохранён для обратной совместимости. Профили с multi-image-входом могут
получать второе изображение из актуального содержимого выбранного слоя или из
внешнего файла; внешний референс копируется внутрь проекта.
...
Текущие движки: диффузия (SDXL), удаление объектов (LaMa), provider-neutral
AI Edit (Qwen Image Edit, FLUX.2, SenseNova U1.5 GGUF и legacy
InstructPix2Pix), сегментация (rembg).
